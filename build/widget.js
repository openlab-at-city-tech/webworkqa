...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var connectToVoteGetter = function connectToVoteGetter(Component) {
		var VoteGetter = _react2['default'].createClass({
			displayName: 'VoteGetter',
			...
			modScore: function modScore(val) {
				val = 1 == val ? 1 : -1;
				this.setState({
			...
			setMyVote: function setMyVote(vote) {
				this.setState({ myvote: vote });
			},
	
			render: function render() {
				return _react2['default'].createElement(Component, _extends({}, this.props, this.state, { onVoteChange: this.toggleVote }));
			}
		});
	...
	var WWProblem = _react2['default'].createClass({
		displayName: 'WWProblem',
		...
		render: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'h2',
					null,
					this.props.problem_data.title
				),
				_react2['default'].createElement(WWProblemSummary, { content: this.props.problem_data.summary }),
				_react2['default'].createElement(WWAskQuestion, { problem_id: this.props.problem_data.id }),
				_react2['default'].createElement(WWQuestionList, { problem_id: this.props.problem_data.id, questions: this.props.problem_data.questions })
			);
		}
	});
	
	var WWProblemSummary = _react2['default'].createClass({
		displayName: 'WWProblemSummary',
	...
	var WWAskQuestion = _react2['default'].createClass({
		displayName: 'WWAskQuestion',
	
		render: function render() {
			return _react2['default'].createElement(
				'div',
				{ className: 'ww-ask-question-form' },
				_react2['default'].createElement(
					'form',
					null,
					_react2['default'].createElement(
					...
					_react2['default'].createElement('input', { type: 'hidden', name: 'ww-problem-id', value: this.props.problem_id }),
					_react2['default'].createElement('textarea', { name: 'ww-question-content', value: '' }),
	...
	var WWQuestionList = _react2['default'].createClass({
		displayName: 'WWQuestionList',
		...
		render: function render() {
			...
			this.props.questions.forEach(function (question) {
				rows.push(_react2['default'].createElement(WWQuestion, { key: question.id, question: question }));
			});
			return _react2['default'].createElement(
				'div',
	...
	var WWQuestion = _react2['default'].createClass({
		displayName: 'WWQuestion',
		...
		render: function render() {
			...
			return _react2['default'].createElement(
				'li',
				{ style: styles.li },
				_react2['default'].createElement(WWScoreDialog, {
				...
				_react2['default'].createElement(
					'div',
					{ className: 'ww-question-content', style: styles.wwQuestionContent },
					this.props.question.content,
					_react2['default'].createElement(WWResponseList, { responses: this.props.question.responses })
				)
			);
		}
	});
	...
	var WWResponseList = _react2['default'].createClass({
		displayName: 'WWResponseList',
		...
		render: function render() {
			...
			this.props.responses.forEach(function (response) {
				rows.push(_react2['default'].createElement(WWResponse, { key: response.id, response: response }));
			});
	...
	var WWResponse = _react2['default'].createClass({
		displayName: 'WWResponse',
	...
	var WWScoreDialog = _react2['default'].createClass({
		displayName: 'WWScoreDialog',
		...
		render: function render() {
			...
			return _react2['default'].createElement(
				'div',
				{ className: 'ww-score', style: styles.wwScore },
				_react2['default'].createElement('div', {
					className: this.getClassName('up'),
					onClick: this.toggleUp,
					style: _Object$assign(styles.uparrow, styles.arrow, this.props.myvote == 'up' ? styles.myvoteup : {}, this.props.myvote == 'down' ? styles.disabledup : {}) }),
				_react2['default'].createElement(
					'div',
					{
				...
				_react2['default'].createElement('div', {
					style: _Object$assign(styles.downarrow, styles.arrow, this.props.myvote == 'down' ? styles.myvotedown : {}, this.props.myvote == 'up' || this.props.score <= 0 ? styles.disableddown : {}),
		...
		toggleDown: function toggleDown() {
		...
		getClassName: function getClassName(mode) {
			var className = 'ww-score-vote ww-score-' + mode;
	...
	_reactDom2['default'].render(_react2['default'].createElement(WWProblem, { problem_data: problem_data }), document.getElementById('webwork-app'));
